...
*Status:* Pembayaran Selesai/Segera Dikirim. Berikut adalah bukti pembayaran terlampir.`;
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-8">
      ...
      {/* FOOTER */}
      <footer className="mt-20 text-center text-xs text-zinc-500 font-mono border-t border-white/5 pt-8 max-w-lg mx-auto">
        <p className="text-zinc-400 font-semibold tracking-widest text-[11px] uppercase">- DI BUAT SEPENUHNYA OLEH BILZX -</p>
      </footer>
